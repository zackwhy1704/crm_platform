...
const mockActions: Action[] = [
  {
    title: "Follow up Marcus Lim",
    reason: "Opened quote 3× today, no WA reply for 6h",
    chip: "$28k deal · high risk",
    priority: "hi",
    cta: "Nudge",
  },
  {
    title: "Assign Sarah Tan",
    reason: "Qualification complete — score 88, hot lead",
    chip: "Ready for assignment",
    priority: "med",
    cta: "Assign",
  },
  {
    title: "Send reminder · Wong meeting",
    reason: "Meeting tomorrow 10am — no confirmation yet",
    chip: "Tomorrow morning",
    priority: "lo",
    cta: "Remind",
  },
  {
    title: "Re-engage Diana Ong",
    reason: "Nurture lead, last contact 7 days ago",
